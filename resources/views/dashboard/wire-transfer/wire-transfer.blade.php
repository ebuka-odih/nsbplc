    ...
    <main id="main-container">
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-xl-4">
                    <!-- Card #1 -->
                    <a class="block block-rounded block-link-shadow" href="{{ route('user.wire_transfer')}}" style="background-color: #2f3654; color: #8492b1;">
                        <div class="block-content block-content-full ribbon ribbon-dark ribbon-modern ribbon-primary">
                            <div class="py-3 text-center">
                        ...
                        <div class="col-lg-12 space-y-2">
                            ...
                            <form class="row row-cols-lg-auto g-3 align-items-center" action="{{ route('user.storeNsbTransfer') }}" method="POST">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select id="country" name="ben_country" class="form-control form-control-lg">
                                ...
                                <div class="col-lg-6">
                                    <label for="example-ltf-text">Beneficiary City<span class="text-danger">*</span></label>
