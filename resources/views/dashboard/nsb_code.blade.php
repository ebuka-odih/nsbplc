                ...
                <div class="block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 space-y-2">
                            ...
                            <form class="row row-cols-lg-auto g-3 align-items-center" action="http://127.0.0.1:8000/user/store/nsb/transfer" method="POST">

                                <div class="col-lg-12">
                                    <label for="example-ltf-text">NSB Code <span class="text-danger">*</span></label>
                                    <input required="" type="text" class="form-control form-control-lg" id="example-if-password" name="amount" placeholder="000111">
                                </div>
                                <div class="col-lg-12">
