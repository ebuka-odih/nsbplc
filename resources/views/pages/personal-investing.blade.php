...
@section('content')
    ...
    <main id="main">
    <table class="Subsection-Header-Nav-Table scroll-active" style="background-image: url('https://www.prosperitybankusa.com/ContentImageHandler.ashx?imageId=138158');">
        <tbody>
        <tr>
            <td>
                <ul>
                    <li>
                        <a href="Individual-Retirement-Accounts-IRAs">Individual Retirement Accounts (IRAs</a>)
                    </li>
                    <li>
                        <a href="Certificates-of-Deposit-CDs">Certificate of Deposit (CDs</a>)
                    </li>
                </ul>
            </td>
        </tr>
        <tr>
            <td>
                <h1>Find the right product for you.</h1>
                <p>For all of your short and long-term savings goals.</p><a class="Button1" href="#Account-Types">LEARN MORE BELOW</a>
            </td>
        </tr>
        </tbody>
    </table>
    <table class="Subsection-Table scroll-active">
        ...
        <tr>
            <td>
                <table class="Table-Grid-Thirds scroll-active" id="Account-Types" style="margin-left: auto; margin-right: auto;">
                    <caption>
                        <h2 id="anchor-1">Types of accounts</h2>
                    </caption>
                    <tbody>
                    <tr>
                        <td>
                            <h3 class="icon-savings">Individual Retirement Accounts (IRAs)</h3>
                            <p>Smart options to help you retire on your own terms</p>
                            <p><a class="Button1" href="Individual-Retirement-Accounts-IRAs">Learn More</a></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <h3 class="icon-certificate">Certificates of Deposit (CDs)</h3>
                            <p>Choose a term option that makes sense for you</p>
                            <p><a class="Button1" href="Certificates-of-Deposit-CDs">Learn More</a></p>
                        </td>
                    </tr>
                    </tbody>
                </table>
