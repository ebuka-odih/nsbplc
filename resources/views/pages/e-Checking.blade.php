...
@section('content')
    ...
    <main id="main">
    <table class="Subsection-Header-Nav-Table scroll-active" style="background-image: url('https://www.prosperitybankusa.com/ContentImageHandler.ashx?imageId=138116');">
        <tbody>
        <tr>
            <td>
                <ul>
                    ...
                    <li>
                        <a href="e-Checking" class="current">e-Checking</a>
                    </li>
                    <li>
                        <a href="Personal-Checking">Personal Checking</a>
                    </li>
                    <li>
                        <a href="Checking-with-Interest">Checking with Interest</a>
                    </li>
                    <li>
        ...
        <tr>
            <td>
                <h1>e-Checking</h1>
                <p>Checking without all of the paper</p>
    ...
    <table class="Subsection-Table scroll-active">
        ...
        <tr>
            <td>
                    ...
                    <tr>
                        <td>
                            <p>
                                ...
                                <strong>ONLINE BANKING AND MOBILE banking</strong>
                            </p>
                        </td>
                    </tr>
                    </tbody>
                ...
                <ul class="List-Column scroll-active">
                    ...
                    <li>Avoid a $10 monthly maintenance fee by enrolling in eStatements or direct deposit</li>
                    <li>Imaged check statements, available when enrolled in eStatements</li>
                    <li>Overdraft protection available up to $600**
                        <br>
                        <br>
                    </li>
                </ul>
        ...
        <tr>
            <td>
                ...
                <p>Residents of Texas or Oklahoma, age 18 and above are eligible to apply for a checking account. Individuals ages 13 – 17 are eligible to open a Teen Checking Account with a parent/guardian as a joint on the account.</p>
                <p>
                ...
                <p>Yes. A debit card is available with all of our checking accounts. ChexSystems will be checked prior to account opening. Debit cards are mailed to the account holder.</p>
                <p>
