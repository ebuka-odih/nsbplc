...
@section('content')
    ...
    <main id="main">
        <table class="Subsection-Header-Nav-Table scroll-active" style="background-image: url('https://www.prosperitybankusa.com/ContentImageHandler.ashx?imageId=138006');">
            <tbody>
            <tr>
                <td>
                    <ul>
                        ...
                        <li>
                            <a href="Small-Business-Checking-with-Interest">Small Business Checking with Interest</a>
                        </li>
                        <li>
                            <a href="Business-Analysis-Checking" class="current">Business Analysis Checking</a>
                        </li>
                        <li>
            ...
            <tr>
                <td>
                    <h1>Business Analysis Checking</h1>
                    <p>Created for larger volume commercial businesses who maintain a higher monthly balance.</p>
                    <p>
            ...
            <tr>
                <td>
                    ...
                    <ul class="List-Column">
                        <li>Charged through an account analysis</li>
                        <li>Free Online Banking</li>
                        <li>Free Mobile Banking</li>
                        <li>$20 monthly maintenance fee</li>
                        <li>Imaged check statements available</li>
                        <li>Treasury Management available</li>
                        <li>Bill Pay $5.95 (an item fee of $.35 for each check in excess of 35 per month applies)</li>
                        <li>Activity Fee: Per item fees may be charged, but can be offset by an earnings credit</li>
                    </ul>
                </td>
            </tr>
            </tbody>
        ...
        <table class="Subsection-Table">
            ...
            <tr>
                <td>
                    ...
                    <p>Residents of Texas or Oklahoma, age 18 and above are eligible to apply for a checking account. Individuals ages 13 – 17 are eligible to open an account with a parent/guardian as a joint on the account.</p>
                    <p>
