...
@section('content')
    ...
    <main id="main">
        <table class="Subsection-Header-Nav-Table scroll-active" style="background-image: url('https://www.prosperitybankusa.com/ContentImageHandler.ashx?imageId=138008');">
            <tbody>
            <tr>
                <td>
                    <ul>
                        ...
                        <li>
                            <a href="Business-Analysis-Checking-with-Interest" class="current">Business Analysis Checking with Interest</a>
                        </li>
                    </ul>
                </td>
            </tr>
            <tr>
                <td>
                    <h1>Business Analysis Checking with Interest</h1>
                    <p>The higher-balance, high-activity account that earns you more.</p>
                    <p>
            ...
            <tr>
                <td>
                    ...
                    <ul class="List-Column">
                        <li>Earn a competitive interest rate on your deposits</li>
                        ...
                        <li>Bill Pay $5.95 (an item of $.35 for each check, in excess of 35 per month applies)</li>
        ...
        <table class="Subsection-Table">
            ...
            <tr>
                <td>
                    ...
                    <p>It takes approximately 15-30 minutes to open an account.</p>
                    <p>
