...
@section('content')
    ...
    <main id="main"><table class="Subsection-Header-Nav-Table scroll-active" style="background-image: url('ContentImageHandler863a.jpg?imageId=138082');">
            <tbody><tr>
                <td><ul>
            ...
            <tr><td>
                    <h1>Prosperity Business Savings</h1><p>Easy to deposit. Easy to access. Easy to earn</p><a href="#Account-Features" class="Button1">LEARN MORE BELOW</a></td></tr>
            </tbody></table>
        <table class="Subsection-Table"><tbody>
            <tr><td>
                    <table class="Table-Grid-Promo"><tbody>
                        <tr><td>
                                <p><strong>$200</strong><strong>minimum to open</strong></p></td>
                        </tr><tr>
                            <td><p><strong>$200</strong><strong>minimum Monthly balance</strong></p></td>
                        </tr><tr>
                            <td><p><strong>Free</strong><strong>Unlimited ATM Withdrawals</strong></p></td>
                        </tr></tbody>
                    </table><h2 id="anchor-1"><a id="Account-Features"></a>Account Features</h2><ul class="List-Column">
                        <li>Earn a competitive interest rate on your balance</li><li>Free Online Banking</li><li>Free Mobile Banking</li><li>Free unlimited withdrawals at Prosperity ATMs</li><li>Avoid a $3 minimum balance fee by maintaining a minimum balance of $200</li><li>Up to 3 free debit transactions per month (an item fee of $2 for each debit transaction after that)</li></ul>
                </td></tr>
            </tbody></table>

        <table class="Subsection-Gray-Table ">
            <tbody>
            <tr>
                <td>
