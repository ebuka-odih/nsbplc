...
@section('content')
    ...
    <main id="main">
        <table class="Subsection-Header-Nav-Table scroll-active" style="background-image: url('https://www.prosperitybankusa.com/ContentImageHandler.ashx?imageId=138087');">
            <tbody>
            <tr>
                <td>
                    <ul>
                        ...
                        <li>
                            <a href="Small-Business-Checking" class="current">Small Business Checking</a>
                        </li>
                        <li>
            ...
            <tr>
                <td>
                    ...
                    <p>Big value for smaller businesses</p>
            ...
            <tr>
                <td>
                    ...
                    <ul class="List-Column">
                        ...
                        <li>Avoid a $10 monthly maintenance fee by maintaining a minimum balance of $3,500, or a deposit relationship balance of $25,000 </li>
