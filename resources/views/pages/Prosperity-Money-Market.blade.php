...
@section('content')
    ...
    <main id="main">
        <table class="Subsection-Header-Nav-Table scroll-active" style="background-image: url('https://www.prosperitybankusa.com/ContentImageHandler.ashx?imageId=138160');">
            <tbody>
            <tr>
                <td>
                    <ul>
                        ...
                        <li>
                            <a href="NSB-Money-Market" class="current">NSB PLC Money Market</a>
                        </li>
                        <li>
                            <a href="Premier-Money-Market">Premier Money Market</a>
                        </li>
                        <li>
                            <a href="nsb-Savings">NSB PLC Savings</a>
                        </li>
                    </ul>
                </td>
            </tr>
            <tr>
                <td>
                    <h1>NSB PLC Money Market</h1>
                    <p>The account for those who want more</p>
            ...
            <tr>
                <td>
                    <table class="Table-Grid-Promo">
                        ...
                        <tr>
                            <td>
                                <p>
                                    <strong>Free</strong>
                                    <strong>And Unlimited withdrawals at NSB PLC ATMs</strong>
                                </p>
                            </td>
                        </tr>
                        </tbody>
                    ...
                    <ul class="List-Column">
                        ...
                        <li>Avoid a $10 monthly maintenance fee by maintaining the minimum balance of $2,500**</li>
                        <li>Free unlimited withdrawals at NSB PLC ATMs</li>
        ...
        <table class="Subsection-Table">
            ...
            <tr>
                <td>
                    ...
                    <p>
                        <strong>How can my child avoid the monthly maintenance fee?</strong>
                    </p>
                    <p>This fee is waived when you maintain a $2,500 minimum balance in your account.</p>
                    <p class="Disclaimer">
