...
<main id="main">
    <table class="Subsection-Header-Nav-Table scroll-active" style="background-image: url('https://www.prosperitybankusa.com/ContentImageHandler.ashx?imageId=138159');">
        <tbody>
        <tr>
            <td>
                <ul>
                    <li>
                        <a href="{{ route('Compare-Personal-Savings-Accounts') }}">Compare All Savings Accounts</a>
                    </li>
                    <li>
                        <a href="NSB-Money-Market">NSB Money Market</a>
                    </li>
                    <li>
                        <a href="Premier-Money-Market" class="current">Premier Money Market</a>
                    </li>
                    <li>
                        <a href="nsb-Savings">NSB Savings</a>
                    </li>
                </ul>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <table class="Table-Grid-Promo scroll-active">
                    ...
                    <tr>
                        <td>
                            <p>
                                <strong>Free</strong>
                                <strong>Withdrawals at Prosperity ATMs</strong>
                            </p>
                        </td>
                    </tr>
                    </tbody>
                ...
                <ul class="List-Column scroll-active">
                    <li>Receive a competitive interest rate on your deposits</li>
                    <li>Free Online Banking</li>
                    <li>Free Mobile Banking</li>
                    <li>Free withdrawals at Prosperity ATMs</li>
                    <li>Avoid a $20 monthly maintenance fee by maintaining a minimum balance of $10,000**</li>
                    <li>Up to 6 debit transactions per statement cycle (an item fee of $15 for each debit transaction in excess of 6 per statement cycle)</li>
    ...
    <table class="Subsection-Table scroll-active">
        ...
        <tr>
            <td>
                ...
                <p>This fee is waived when you maintain a $10,000 minimum balance in your account.</p>
                <p class="Disclaimer">
                    <strong>Important Notice:</strong>
                </p>
                <p class="Disclaimer">Other agreements that you have with the Bank, may further limit the number of these transactions.* Rates and terms are subject to change without notice at Prosperity Bank's discretion and/or as required or allowed by law. **Bill Pay not available on this account. Fee is waived when you maintain a $10,000 minimum balance in your account.</p>
            </td>
        </tr>
        </tbody>
    </table>
