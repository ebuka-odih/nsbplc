    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('new_account') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    <label class="" for="example-if-phone">Phone</label>
                    <span style="color: red !important; display: inline; float: none;">*</span>
                    <input  type="tel" required name="phone" class="form-control form-control-alt" id="example-if-phone"  >
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-6">
                    ...
                    <span style="color: red !important; display: inline; float: none;">*</span>
                    <input name="avatar" type="file" class="form-control form-control-file" id="inputZip">
                </div>
