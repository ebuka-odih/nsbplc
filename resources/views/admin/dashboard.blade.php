                            ...
                            <div class="card widget-box-one border border-primary bg-soft-primary">
                                <div class="card-body">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-weight-bold text-muted" title="Statistics">Total Deposits</p>
                                        <h2><span >$@convert($deposits)</span>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card widget-box-one border border-warning bg-soft-warning">
                                <div class="card-body">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-weight-bold text-muted" title="User This Month">Total Withdrawals</p>
                                        <h2><span >$@convert($withdrawal) </span> <i class="mdi mdi-arrow-up text-success font-24"></i></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card widget-box-one border border-danger bg-soft-danger">
                                <div class="card-body">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-weight-bold text-muted" title="Statistics">Total Users</p>
                                        <h2><span >{{ $users }} </span> <i class="mdi mdi-arrow-up text-success font-24"></i></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card widget-box-one border border-success bg-soft-success">
                                <div class="card-body">
                                    ...
                                    <div class="wigdet-one-content">
                                        ...
                                        <h2><span data-plugin="counterup">0</span> <i class="mdi mdi-arrow-down text-danger font-24"></i></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
