                    ...
                    <div class="col-lg-12 space-y-2">
                        ...
                        <form class="row row-cols-lg-auto g-3 align-items-center" action="{{ route('admin.update_user', $user_details->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input readonly value="{{ old('first_name', optional($user_details)->first_name)  }}" type="text" class="form-control form-control-alt"  id="example-if-email2" name="first_name" >
                            </div>
                            <div class="col-lg-4">
