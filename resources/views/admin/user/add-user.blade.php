        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Add Account</h1>
                </div>
            </div>
        </div>
        <!-- END Hero -->
                ...
                <div class="block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 space-y-2">
                            ...
                            <form class="row row-cols-lg-auto g-3 align-items-center" action="{{ route('admin.store_user') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input  type="tel" required name="phone" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input  type="date" name="date_of_birth" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input  type="text" name="state" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">City</label>
                                    <input type="text" name="city" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Address</label>
                                    <input  type="text" name="address" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Address 2</label>
                                    <input  type="text" name="address_2" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Zipcode</label>
                                    <input  type="text" name="zipcode" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input   type="text" name="occupation" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Position</label>
                                    <input   type="text" name="position" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Employer Name</label>
                                    <input   type="text" name="employer_name" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Office Address</label>
                                    <input   type="text" name="office_address" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Office Name</label>
                                    <input   type="text" name="office_name" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Annual Salary</label>
                                    <input   type="text" name="annual_salary" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-12">
                                    <div class="block-header block-header-default">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input   type="text" name="cus_idnumber" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Identification Expiry Date</label>
                                    <input   type="text" name="cus_expiry" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Identification Image</label>
                                    <input   type="file" name="cus_image" class="form-control form-control-file" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-12">
                                    <div class="block-header block-header-default">
